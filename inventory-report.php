        ...
        <div class="bg-white rounded-lg shadow p-6 mb-8">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                    ...
                    <select name="filter_type" class="w-full px-4 py-2 border rounded">
                        <option value="all" <?php echo $filter_type === 'all' ? 'selected' : ''; ?>>All Inventory</option>
                        <option value="expiring_soon" <?php echo $filter_type === 'expiring_soon' ? 'selected' : ''; ?>>Expiring Soon (3 months)</option>
                        <option value="expired" <?php echo $filter_type === 'expired' ? 'selected' : ''; ?>>Expired Items</option>
                        <option value="low_stock" <?php echo $filter_type === 'low_stock' ? 'selected' : ''; ?>>Low Stock Items</option>
                    </select>
                </div>
                <div>
