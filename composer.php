...
function sendVerificationEmail($recipientEmail, $verificationCode) {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'milanmathew6656@gmail.com';
        $mail->Password   = 'blya mtww lewn pmdv';
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port       = 587;

        $mail->setFrom('milanmathew6656@gmail.com', 'Pharma Corp');
...
<head>
    ...
    <title>Pharma Corp - OTP Verification</title>
...
<body>
    <div class="login-container">
        <div class="logo">
            <span class="task">Pharma Corp</span>
        </div>
